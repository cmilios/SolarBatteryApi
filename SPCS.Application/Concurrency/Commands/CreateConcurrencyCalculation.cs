...
namespace SPCS.Application.Concurrency.Commands
{
    ...
    public class CreateConcurrencyCalculationCommandHandler(IConcurrencyCalculator concurrencyCalculator) : IRequestHandler<CreateConcurrencyCalculationCommand, ConcurrencyCalculationDto>
    {
        ...
        public Task<ConcurrencyCalculationDto> Handle(CreateConcurrencyCalculationCommand request, CancellationToken cancellationToken)
        {
